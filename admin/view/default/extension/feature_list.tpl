          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;">
                {if $feature['selected']}
                  <input type="checkbox" name="selected[]" value="{$feature['feature_id']}" checked="checked" onclick="$(this).attr('checked',checked);" />
                {else}
                  <input type="checkbox" name="selected[]" value="{$feature['feature_id']}" onclick="$(this).attr('checked',checked);" />
                {/if}
                </td>
              <td class="left">{$feature['name']}</td>
              <td class="left">{$feature['title']}</td>
              <td class="left">{$feature['status']}</td>
              <td class="right">
                [ <a href="/admin/extension/feature/update/{$feature['feature_id']}">{$button_edit}</a> ]
              </td>
            </tr>
            {/foreach}
            {else}
