          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;">
                {if $style['selected']}
                  <input type="checkbox" name="selected[]" value="{$style['style_id']}" checked="checked" onclick="$(this).attr('checked',checked);" />
                {else}
                  <input type="checkbox" name="selected[]" value="{$style['style_id']}" onclick="$(this).attr('checked',checked);" />
                {/if}
                </td>
              <td class="left">{$style['name']}</td>
              <td class="left">{$types[$style['type']]}</td>
              <td class="left">{$style['status']}</td>
              <td class="right">
                [ <a href="/admin/extension/style/update/{$style['style_id']}">{$button_edit}</a> ]
              </td>
            </tr>
            {/foreach}
            {else}
